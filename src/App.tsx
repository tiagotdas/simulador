 ...
 * Definidos no topo com sintaxe de função para garantir hoisting e evitar ReferenceErrors.
 */
...
function calculateGreeks(S: number, K: number, daysToMaturity: number, sigma: number, type: OptionType) {
...
function getOptionValueAtExpiry(type: OptionType, strike: number, spot: number): number {
...
function calculatePayoff(legs: Leg[], spotRange: number[]) {
...
function calculateMetrics(legs: Leg[], payoffData: { price: number; value: number }[]) {
  ...
  legs.forEach(l => {
    ...
    payoffAtZero += isB ? (vZ * l.quantity) - c : c - (vZ * l.quantity);
...
const generateUUIDStr = () => Math.random().toString(36).substring(2, 9);
...
const STRATEGIES: StrategyTemplate[] = [
  ...
  { name: "1. Compra de Call (Long)", category: "Bullish", description: "Compra de Call a seco.", details: { thesis: "Expectativa de forte valorização.", mechanics: "Aquisição de direito de compra com alavancagem.", idealScenario: "Movimento explosivo de alta no curto prazo.", greeks: "Delta Positivo, Gamma Positivo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot, quantity: 100, price: 2.5 }] },
  { name: "2. Venda de Put (Naked)", category: "Bullish", description: "Venda de Put a seco.", details: { thesis: "Mercado estável ou levemente altista.", mechanics: "Venda de obrigação de compra para coleta de prémio.", idealScenario: "Ativo permanece acima do strike até à maturidade.", greeks: "Theta Positivo (Renda)" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.95, quantity: 100, price: 2.0 }] },
  { name: "3. Spread de Alta com Call", category: "Bullish", description: "Bull Call Spread.", details: { thesis: "Valorização moderada com custo reduzido.", mechanics: "Compra Call ATM e Venda Call OTM.", idealScenario: "Ativo atinge o strike da Call vendida.", greeks: "Risco limitado, Retorno definido" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot, quantity: 100, price: 5.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.05, quantity: 100, price: 2.0 }] },
  { name: "4. Spread de Alta com Put", category: "Bullish", description: "Bull Put Spread.", details: { thesis: "Rentabilização em mercado lateral/altista.", mechanics: "Venda Put ATM e Compra Put OTM.", idealScenario: "Ativo termina acima do strike vendido.", greeks: "Theta Positivo, Delta Positivo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.95, quantity: 100, price: 3.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 0.90, quantity: 100, price: 1.0 }] },
  { name: "5. Call Ratio Spread", category: "Bullish", description: "Compra 1, Venda 2 Calls.", details: { thesis: "Alta moderada com potencial de custo zero.", mechanics: "Financiamento da compra pela venda dupla de OTM.", idealScenario: "Ativo para exatamente no strike vendido.", greeks: "Delta variável, Risco na alta explosiva" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot, quantity: 100, price: 5.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.05, quantity: 200, price: 2.0 }] },
  { name: "6. Risk Reversal", category: "Bullish", description: "Financiamento de Call com Put.", details: { thesis: "Simulação de compra de ativo com proteção.", mechanics: "Compra Call OTM financiada pela Venda de Put OTM.", idealScenario: "Subida expressiva do ativo subjacente.", greeks: "Delta aproximado de 0.5 a 1.0" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 1.05, quantity: 100, price: 3.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.95, quantity: 100, price: 3.0 }] },
  { name: "7. Call Backspread", category: "Bullish", description: "Venda 1, Compra 2 Calls.", details: { thesis: "Aposta em volatilidade extrema na alta.", mechanics: "Venda Call ATM e Compra de maior volume de OTM.", idealScenario: "Rompimento violento da resistência superior.", greeks: "Gamma Positivo, Vega Positivo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot, quantity: 100, price: 5.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 1.05, quantity: 200, price: 2.0 }] },
  { name: "8. Bull Call Ladder", category: "Bullish", description: "Escada de Alta.", details: { thesis: "Alta moderada com intervalo de lucro amplo.", mechanics: "Bull Spread com venda de Call adicional superior.", idealScenario: "Alta gradual até o penúltimo strike.", greeks: "Theta Positivo no intervalo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot, quantity: 100, price: 5.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.05, quantity: 100, price: 2.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.10, quantity: 100, price: 1.0 }] },
  { name: "9. Ativo Sintético", category: "Bullish", description: "Simulação de compra de ação.", details: { thesis: "Exposição ao ativo com baixo capital.", mechanics: "Compra Call ATM e Venda Put ATM.", idealScenario: "Qualquer valorização do ativo.", greeks: "Delta 1.0 (Réplica perfeita)" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot, quantity: 100, price: 4.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot, quantity: 100, price: 4.0 }] },

  // ESTRATÉGIAS DE BAIXA (BEARISH)
  { name: "10. Compra de Put (Long)", category: "Bearish", description: "Compra de Put a seco.", details: { thesis: "Hedge ou aposta em queda.", mechanics: "Direito de vender o ativo a preço fixo.", idealScenario: "Desvalorização brusca do mercado.", greeks: "Delta Negativo, Gamma Positivo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot, quantity: 100, price: 2.5 }] },
  { name: "11. Venda de Call (Naked)", category: "Bearish", description: "Venda de Call a seco.", details: { thesis: "Mercado em queda ou lateral.", mechanics: "Obrigação de venda. Alto risco na alta.", idealScenario: "Ativo termina abaixo do strike.", greeks: "Theta Positivo, Risco Ilimitado" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.05, quantity: 100, price: 2.0 }] },
  { name: "12. Spread de Baixa com Put", category: "Bearish", description: "Bear Put Spread.", details: { thesis: "Queda moderada com custo definido.", mechanics: "Compra Put ATM e Venda Put OTM.", idealScenario: "Ativo cai até ao strike inferior.", greeks: "Risco limitado, Lucro máximo no strike" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot, quantity: 100, price: 5.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.95, quantity: 100, price: 2.0 }] },
  { name: "13. Spread de Baixa com Call", category: "Bearish", description: "Bear Call Spread.", details: { thesis: "Geração de renda em baixa/lateralização.", mechanics: "Venda Call ATM e Compra Call OTM.", idealScenario: "Ativo permanece abaixo do strike vendido.", greeks: "Theta Positivo, Risco Limitado" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.05, quantity: 100, price: 3.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 1.10, quantity: 100, price: 1.0 }] },
  { name: "14. Put Ratio Spread", category: "Bearish", description: "Compra 1, Venda 2 Puts.", details: { thesis: "Queda moderada com hedge parcial.", mechanics: "Compra Put e Venda dupla de Puts mais baratas.", idealScenario: "Pin no strike vendido (lucro máximo).", greeks: "Risco em queda catastrófica" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot, quantity: 100, price: 5.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.90, quantity: 200, price: 1.5 }] },
  { name: "15. Put Backspread", category: "Bearish", description: "Venda 1, Compra 2 Puts.", details: { thesis: "Lucro em crash ou pânico financeiro.", mechanics: "Venda Put ITM e Compra Puts OTM.", idealScenario: "Queda livre do preço do ativo.", greeks: "Gamma Positivo na ponta baixa" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot, quantity: 100, price: 5.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 0.90, quantity: 200, price: 2.0 }] },
  { name: "16. Escada de Baixa", category: "Bearish", description: "Bear Put Ladder.", details: { thesis: "Queda suave gerando crédito inicial.", mechanics: "Bear Put Spread com Venda de Put adicional.", idealScenario: "Ativo estabiliza no corpo da escada.", greeks: "Theta Positivo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot, quantity: 100, price: 5.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.95, quantity: 100, price: 2.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.90, quantity: 100, price: 1.0 }] },
  { name: "17. Vendido Sintético", category: "Bearish", description: "Réplica de Short Stock.", details: { thesis: "Exposição à queda sem aluguer de ações.", mechanics: "Venda Call ATM e Compra Put ATM.", idealScenario: "Qualquer desvalorização do ativo.", greeks: "Delta -1.0" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot, quantity: 100, price: 4.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot, quantity: 100, price: 4.0 }] },
  { name: "18. Put Sintética (Hedged Stock)", category: "Bearish", description: "Proteção de Stock.", details: { thesis: "Manter exposição à alta com limite de perda.", mechanics: "Venda de Stock + Compra de Call.", idealScenario: "Queda imediata após venda do ativo base.", greeks: "Proteção contra Tail Risk" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Stock', action: 'Sell', strike: spot, quantity: 100, price: spot }, { id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot, quantity: 100, price: 2.5 }] },

  // VOLATILIDADE (VOLATILITY)
  { name: "19. Straddle Comprado", category: "Volatility", description: "Compra Call e Put ATM.", details: { thesis: "Aposta em movimento direcional incerto.", mechanics: "Compra de volatilidade pura.", idealScenario: "Rompimento forte de triângulo ou notícia.", greeks: "Vega Positivo, Gamma Alto" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot, quantity: 100, price: 4.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot, quantity: 100, price: 4.0 }] },
  { name: "20. Strangle Comprado", category: "Volatility", description: "Compra OTM.", details: { thesis: "Explosão de preço com baixo custo.", mechanics: "Opções fora do dinheiro para alavancagem.", idealScenario: "Movimento extremo e violento.", greeks: "Vega Positivo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 0.95, quantity: 100, price: 2.5 }, { id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 1.05, quantity: 100, price: 2.5 }] },
  { name: "21. Strip", category: "Volatility", description: "Straddle com viés de baixa.", details: { thesis: "Volatilidade com maior probabilidade de queda.", mechanics: "2 Puts + 1 Call ATM.", idealScenario: "Forte desvalorização.", greeks: "Gamma assimétrico" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot, quantity: 200, price: 4.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot, quantity: 100, price: 4.0 }] },
  { name: "22. Strap", category: "Volatility", description: "Straddle com viés de alta.", details: { thesis: "Volatilidade com maior probabilidade de subida.", mechanics: "2 Calls + 1 Put ATM.", idealScenario: "Forte valorização.", greeks: "Gamma assimétrico" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot, quantity: 200, price: 4.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot, quantity: 100, price: 4.0 }] },
  { name: "23. Guts", category: "Volatility", description: "Compra ITM dupla.", details: { thesis: "Volatilidade com Delta estável.", mechanics: "Compra Call e Put dentro do dinheiro.", idealScenario: "Movimento amplo e linear.", greeks: "Delta Neutro, Gamma Reduzido" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 0.95, quantity: 100, price: 6.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 1.05, quantity: 100, price: 6.0 }] },
  { name: "24. Iron Condor Reverso", category: "Volatility", description: "Saída de intervalo.", details: { thesis: "Ativo parado deve romper barreira lateral.", mechanics: "Compra de asas internas e venda externas.", idealScenario: "Rompimento do suporte ou resistência.", greeks: "Vega Positivo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.90, quantity: 100, price: 1.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 0.95, quantity: 100, price: 3.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 1.05, quantity: 100, price: 3.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.10, quantity: 100, price: 1.0 }] },
  { name: "25. Borboleta Reversa (Call)", category: "Volatility", description: "Explosão central.", details: { thesis: "Aposta que o ativo sairá do preço atual.", mechanics: "Venda do miolo e compra de asas.", idealScenario: "Afastamento significativo do centro.", greeks: "Vega Positivo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 0.95, quantity: 100, price: 6.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot, quantity: 200, price: 3.5 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.05, quantity: 100, price: 1.5 }] },
  { name: "26. Borboleta Reversa (Put)", category: "Volatility", description: "Versão Puts.", details: { thesis: "Explosão de volatilidade utilizando Puts.", mechanics: "Simetria de Puts para movimento direcional.", idealScenario: "Ativo longe do strike central.", greeks: "Vega Positivo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.95, quantity: 100, price: 6.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot, quantity: 200, price: 3.5 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 1.05, quantity: 100, price: 1.5 }] },
  { name: "27. Double Ratio (Volatility)", category: "Volatility", description: "Backspread total.", details: { thesis: "Grande expansão lateral do ativo.", mechanics: "Venda ATM dupla e compra OTM quádrupla.", idealScenario: "Expansão da volatilidade implícita.", greeks: "Gamma Positivo em ambos os lados" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot, quantity: 100, price: 4.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 1.05, quantity: 200, price: 1.5 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot, quantity: 100, price: 4.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 0.95, quantity: 200, price: 1.5 }] },

  // RENDA (INCOME)
  { name: "28. Straddle Vendido", category: "Income", description: "Venda de Volatilidade ATM.", details: { thesis: "Aposta em mercado totalmente parado.", mechanics: "Recebimento de prémio máximo (Vega-).", idealScenario: "Pin perfeito no strike.", greeks: "Theta Positivo Máximo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot, quantity: 100, price: 4.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot, quantity: 100, price: 4.0 }] },
  { name: "29. Strangle Vendido", category: "Income", description: "Venda de Volatilidade OTM.", details: { thesis: "Mercado em intervalo lateral.", mechanics: "Venda de prémio fora do dinheiro.", idealScenario: "Ativo termina entre os strikes.", greeks: "Theta Positivo, Margem Requerida" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.90, quantity: 100, price: 2.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.10, quantity: 100, price: 2.0 }] },
  { name: "30. Iron Condor (Renda)", category: "Income", description: "Renda protegida.", details: { thesis: "Lateralização com risco limitado.", mechanics: "Venda de Strangle com compra de proteção externa.", idealScenario: "Ativo termina no miolo do condor.", greeks: "Theta Positivo, Risco Definido" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 0.90, quantity: 100, price: 1.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.95, quantity: 100, price: 3.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.05, quantity: 100, price: 3.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 1.10, quantity: 100, price: 1.0 }] },
  { name: "31. Iron Butterfly (Renda)", category: "Income", description: "Straddle protegido.", details: { thesis: "Mercado sem movimento com baixo risco.", mechanics: "Venda de Straddle + Compra de asas OTM.", idealScenario: "Ativo fecha exatamente no strike central.", greeks: "Theta Positivo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 0.95, quantity: 100, price: 2.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot, quantity: 100, price: 5.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot, quantity: 100, price: 5.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 1.05, quantity: 100, price: 2.0 }] },
  { name: "32. Borboleta Clássica (Call)", category: "Income", description: "Borboleta de Calls.", details: { thesis: "Precisão cirúrgica de preço.", mechanics: "Simetria 1-2-1 para custo reduzido.", idealScenario: "Ativo no strike das Calls vendidas.", greeks: "Theta Positivo alto" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 0.95, quantity: 100, price: 6.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot, quantity: 200, price: 3.5 }, { id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 1.05, quantity: 100, price: 1.5 }] },
  { name: "33. Borboleta Clássica (Put)", category: "Income", description: "Borboleta de Puts.", details: { thesis: "Alvo de queda preciso.", mechanics: "Combinação 1-2-1 com Puts.", idealScenario: "Pin no strike central das Puts.", greeks: "Theta Positivo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 0.95, quantity: 100, price: 1.5 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot, quantity: 200, price: 3.5 }, { id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 1.05, quantity: 100, price: 6.0 }] },
  { name: "34. Broken Wing (Call)", category: "Income", description: "Borboleta Assimétrica.", details: { thesis: "Viés de alta sem custo na subida.", mechanics: "Asa superior aberta (strike mais distante).", idealScenario: "Ativo estável ou em valorização.", greeks: "Theta Positivo, Delta Positivo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 0.95, quantity: 100, price: 6.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot, quantity: 200, price: 3.5 }, { id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 1.10, quantity: 100, price: 0.5 }] },
  { name: "35. Broken Wing (Put)", category: "Income", description: "Borboleta Assimétrica P.", details: { thesis: "Viés de baixa sem risco na queda.", mechanics: "Asa inferior aberta.", idealScenario: "Ativo estável ou em desvalorização.", greeks: "Theta Positivo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 0.90, quantity: 100, price: 0.5 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot, quantity: 200, price: 3.5 }, { id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 1.05, quantity: 100, price: 6.0 }] },
  { name: "36. Árvore de Natal (Call)", category: "Income", description: "Christmas Tree 1-3-2.", details: { thesis: "Valorização lenta e controlada.", mechanics: "Compra 1, pula strike, venda 3, compra 2.", idealScenario: "Pico de lucro no strike vendido.", greeks: "Theta Positivo, Vega Negativo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 0.95, quantity: 100, price: 6.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.05, quantity: 300, price: 1.5 }, { id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 1.10, quantity: 200, price: 0.5 }] },
  { name: "37. Árvore de Natal (Put)", category: "Income", description: "Christmas Tree Puts.", details: { thesis: "Queda lenta gerando renda.", mechanics: "Estrutura 1-3-2 de Puts.", idealScenario: "Preço no strike de venda tripla.", greeks: "Theta Positivo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 1.05, quantity: 100, price: 6.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.95, quantity: 300, price: 1.5 }, { id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 0.90, quantity: 200, price: 0.5 }] },
  { name: "38. Condor de Call", category: "Income", description: "Corpo largo.", details: { thesis: "Amplo intervalo de lucro.", mechanics: "Venda de miolo largo com proteções.", idealScenario: "Ativo estabilizado entre os strikes centrais.", greeks: "Theta Positivo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 0.90, quantity: 100, price: 9.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 0.95, quantity: 100, price: 6.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.05, quantity: 100, price: 2.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 1.10, quantity: 100, price: 0.5 }] },

  // PROTEÇÃO (HEDGE)
  { name: "39. Jade Lizard", category: "Hedge", description: "Put + Bear Call.", details: { thesis: "Renda em mercado lateral/altista.", mechanics: "Venda de Put financia Bear Call Spread.", idealScenario: "Acima do strike vendido da Put.", greeks: "Delta Positivo, Vega Negativo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.90, quantity: 100, price: 4.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.05, quantity: 100, price: 2.5 }, { id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 1.10, quantity: 100, price: 1.0 }] },
  { name: "40. Twisted Sister", category: "Hedge", description: "Inverso Jade Lizard.", details: { thesis: "Renda em mercado lateral/baixista.", mechanics: "Venda de Call financia Bull Put Spread.", idealScenario: "Abaixo do strike vendido da Call.", greeks: "Delta Negativo" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.10, quantity: 100, price: 2.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.95, quantity: 100, price: 3.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 0.90, quantity: 100, price: 1.0 }] },
  { name: "41. Seagull Bullish", category: "Hedge", description: "Spread de alta financiado.", details: { thesis: "Hedge parcial com viés de alta.", mechanics: "Bull Call Spread + Venda de Put OTM.", idealScenario: "Valorização expressiva do ativo.", greeks: "Delta Positivo alto" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot, quantity: 100, price: 5.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.05, quantity: 100, price: 2.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.90, quantity: 100, price: 3.0 }] },
  { name: "42. Box Spread", category: "Hedge", description: "Arbitragem isenta.", details: { thesis: "Renda fixa via derivativos.", mechanics: "Trava de alta Call + Trava de baixa Put ATM.", idealScenario: "Inexistência de risco direcional.", greeks: "Delta Zero, Gamma Zero" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot * 0.95, quantity: 100, price: 6.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.05, quantity: 100, price: 2.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 1.05, quantity: 100, price: 6.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot * 0.95, quantity: 100, price: 2.0 }] },
  { name: "43. Fence (Collar)", category: "Hedge", description: "Seguro de carteira.", details: { thesis: "Hedge de ativo físico (ações).", mechanics: "Compra de Put financiada por Venda Call OTM.", idealScenario: "Queda acentuada protegendo o valor do ativo.", greeks: "Delta-" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 0.95, quantity: 100, price: 3.0 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.05, quantity: 100, price: 2.5 }] },
  { name: "44. Lançamento Coberto 1x2", category: "Hedge", description: "Venda Coberta Ratio.", details: { thesis: "Potencializar renda em lateralização.", mechanics: "Ativo físico + Venda dupla de Calls OTM.", idealScenario: "Alta leve até o strike vendido.", greeks: "Theta++" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Stock', action: 'Buy', strike: spot, quantity: 100, price: spot }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.05, quantity: 200, price: 2.0 }] },
  { name: "45. Collar Sintético", category: "Hedge", description: "Seguro Total.", details: { thesis: "Proteção sem capital imobilizado.", mechanics: "Stock Sintético + Compra de Put e Venda Call.", idealScenario: "Alta moderada mantendo o seguro contra quedas.", greeks: "Delta Controlado" }, setup: (spot) => [{ id: generateUUIDStr(), type: 'Call', action: 'Buy', strike: spot, quantity: 100, price: 4.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Sell', strike: spot, quantity: 100, price: 4.0 }, { id: generateUUIDStr(), type: 'Put', action: 'Buy', strike: spot * 0.90, quantity: 100, price: 1.5 }, { id: generateUUIDStr(), type: 'Call', action: 'Sell', strike: spot * 1.10, quantity: 100, price: 1.0 }] }
];
...
export default function OptionsStrategyBuilder() {
  ...
  const addLegFromMarket = (option: MarketOption | undefined, action: ActionType) => {
    if (!option) return;
    // Removendo chaves duplicadas (strike, type) para cumprir regras de build TS
    setLegs([...legs, { 
      ...option,
      id: generateUUIDStr(), 
      action, 
